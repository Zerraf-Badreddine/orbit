      ...
      <section className="hero-section relative pt-32 pb-20 px-6 md:px-12 max-w-[1600px] mx-auto min-h-[90vh] flex flex-col">
        ...
        <div className="absolute inset-0 pointer-events-none px-6 md:px-12">
            <div className="h-full w-full border-x border-[#E5E5E5]/50 grid grid-cols-1 md:grid-cols-12 divide-x divide-[#E5E5E5]/50">
               {[...Array(12)].map((_,i) => <div key={i} className="hidden md:block" />)}
            </div>
        </div>

        <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 h-full flex-1">
           {/* Headline Area - Top Left */}
           <div className="col-span-12 md:col-span-12 border-b border-[#111] pb-12 pt-12 md:pt-24">
           ...
           {/* Subtext Area - Bottom Right aligned to grid columns */}
           <div className="col-span-12 md:col-span-5 md:col-start-8 pt-12 flex flex-col justify-between space-y-12">
              <p className="text-xl md:text-2xl leading-relaxed text-[#444]">
                The complete operating system for high-performance freelancers. 
                <span className="text-[#111] font-medium block mt-2">
                   Bandwidth + Revenue + Time
                </span>
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/signup" className="bg-[#111] text-white px-8 py-4 text-lg font-medium rounded-sm hover:bg-[#EA580C] transition-all text-center">
                    Start 14-day trial
                </Link>
           ...
           {/* Stats/Social Proof - Bottom Left */}
           <div className="col-span-12 md:col-span-6 pt-12 flex items-end">
              <div className="grid grid-cols-3 gap-12 w-full">
                 <div>
                    <div className="text-3xl font-serif text-[#111]">$4.2M</div>
                    <div className="text-sm text-[#666] uppercase tracking-wide mt-1">Tracked</div>
                 </div>
                 <div>
                    <div className="text-3xl font-serif text-[#111]">12k+</div>
                    <div className="text-sm text-[#666] uppercase tracking-wide mt-1">Users</div>
                 </div>
              </div>
           </div>
        </div>
